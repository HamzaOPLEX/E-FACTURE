...
from efacture import views
from efacture.Handlers import (
    Users_Handler,
    Facture_Handler,
    GETJsonINFO_Handler,
    Clients_Handler,
...
urlpatterns = [
    ...
    path('devis-to-facture/<int:Devis_id>',
         Devis_Handler.H_Devis_To_Facture, name='Convert Devis To Facture'),
    ...
    path('profile/delete/<int:id>', Facture_Handler.H_Delete_Facture,
         name='Delete Facture By Id'),
    ...
    path('settings/global-settings',
         views.GlobaleSettings, name='Globale Settings'),
    # Manage Products
    path('settings/manage-products',
         Products_Handler.ManageProducts, name='Manage Products'),
    path('settings/manage-products/edit/<int:id>',
         Products_Handler.EditProduct, name='Manage Products'),
    path('settings/manage-products/delete/<int:id>',
         Products_Handler.DeleteProduct, name='Manage Products'),
    # Manage Clients
